...
To be fair, Hurl is really close conceptually to what I want.
...
developer is the one reading failures and deciding what to fix next.

Agents remain second-class users.

---

## TUI Clients ([Posting](https://posting.sh/),
[ATAC](https://github.com/Julien-cpsn/ATAC)): Interaction Reimagined

[Posting](https://posting.sh/) actually serialises requests in yaml very
similar to **yapi**. It wouldn't be too hard to write a Posting adapter for
**yapi**.
